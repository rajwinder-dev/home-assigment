...
import { ArrowDown, ArrowUp, LayoutList, Network, Search } from 'lucide-react';
  ...
  return (
    <>
      <div className="flex flex-wrap items-center justify-between gap-2 p-2">
        {/* Search — hidden in tree view, tree always shows the full org */}
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="border-border flex h-8 items-center rounded-md border p-0.5">
            <Button
                      ...
                      return (
                        <TableRow key={employee.id} className="group/row">
                          ...
                          <TableCell>
                            <Badge
                              variant={
                                employee.active ? 'default' : 'secondary'
                              }
                            >
